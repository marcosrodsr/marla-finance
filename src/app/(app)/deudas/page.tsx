            ...
            <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                ...
                <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:gap-3 w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-3 sm:py-2 rounded-xl text-xs font-bold bg-emerald-600/20 text-emerald-400 border border-emerald-500/30 hover:bg-emerald-600/30 transition-all whitespace-nowrap w-full sm:w-auto min-h-[44px] sm:min-h-0"
                    >
